                    ...
                    <ul class="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                ...
                                aria-controls="pills-home" aria-selected="true">All Courses</button>
                        </li>
                        <li class="nav-item" role="presentation">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_1.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('frontend/images/love_icon_black.png') }}"
                                                alt="Love" class="img-fluid">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('frontend/images/compare_icon_black.png') }}"
                                                alt="Compare" class="img-fluid">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('frontend/images/cart_icon_black_2.png') }}"
                            ...
                            <div class="wsus__single_courses_text_3">
                                ...
                                <a class="author" href="#">
                                    <div class="img">
                                        <img src="{{ asset('frontend/images/author_img_2.jpg') }}" alt="Author"
                                            class="img-fluid">
                                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_2.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_3.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_4.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_9.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_6.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_7.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            <div class="wsus__single_courses_3_img">
                                <img src="{{ asset('frontend/images/courses_3_img_8.jpg') }}" alt="Courses"
                                    class="img-fluid">
                                <ul>
                                    <li>
                                        <a href="#">
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4">
                        <div class="wsus__single_courses_3">
                            ...
                            <div class="wsus__single_courses_text_3">
                                ...
                                <a class="author" href="#">
                                    <div class="img">
                                        <img src="{{ asset('frontend/images/author_img_2.jpg') }}"
