...
@push('admin-css')
    <title>Admin | Update Course Category</title>
@endpush
            ...
            <div class="card-body">
                <form action="{{ route('admin.course-category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <small>You Can Get Icon Class Form:<a target="_blank" href="https://tabler.io/icons">https://tabler.io/icons</a></small>
                        @if ($errors->has('icon'))
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="custom-switch">
                                    <input {{ $category->show_at_trending === 1 ? 'checked' : '' }} type="checkbox" name="show_at_trending" value="1"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <label class="custom-switch">
                                    <input {{ $category->status === 1 ? 'checked' : '' }} type="checkbox" name="status" value="1" class="custom-switch-input">
                                    <span class="custom-switch-indicator"></span>
                                    <span class="custom-switch-description"></span>
                                </label>
                            </div>
